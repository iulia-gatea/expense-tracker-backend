...
public class ExpenseServiceImplTest {
    ...
    public void testGetAllExpenseCategories_ShouldReturnDistinctCategories() {
        ...
        // Act
        List<String> categories = expenseService.getAllExpenseCategories(1L);
    ...
    public void testGetExpenseByCategoryAndMonth_ShouldReturnFilteredExpenses() {
        ...
        // Act
        List<Expense> filteredExpenses = expenseService.getExpenseByCategoryAndMonth("Food", "2024-04", 1L);

        // Assert
        assertThat(filteredExpenses).hasSize(1);
        assertThat(filteredExpenses.get(0).getCategory()).isEqualTo("Food");
    ...
    public void testGetAllExpenseCategories_WithDuplicateCategories_ShouldReturnDistinct() {
        ...
        expense3.setId(3L);
        expense3.setCategory("Food"); // Duplicate category
